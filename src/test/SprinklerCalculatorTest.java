...
public class SprinklerCalculatorTest {
    ...
    @Test
    public void test_givenOneSprinklerCoveredLessThanGarden1_expectOne() {
        List<Sprinkler> sprinklerList = new ArrayList<>();
    ...
    @Test
    public void test_givenOneSprinklerCoveredLessThanGarden2_expectOne() {
        List<Sprinkler> sprinklerList = new ArrayList<>();
    ...
    @Test
    public void test_givenTwoSprinklerEachCoveredThanGarden_expectOne() {
        List<Sprinkler> sprinklerList = new ArrayList<>();
